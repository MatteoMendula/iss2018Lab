...
public abstract class AbstractQacoapanotherobserver extends QActor implements IActivity{ 
	...
	protected IActorAction action;
		...
		protected static IOutputEnvView setTheEnv(IOutputEnvView outEnvView ){
			EnvFrame env = new EnvFrame( "Env_qacoapanotherobserver", java.awt.Color.cyan  , java.awt.Color.black );
			env.init();
			env.setSize(800,430); 
			IOutputEnvView newOutEnvView = ((EnvFrame) env).getOutputEnvView();
			return newOutEnvView;
		}
		public AbstractQacoapanotherobserver(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qacoapanotherobserver/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			addInputPanel(80);
			addCmdPanels();
			this.planFilePath = "./srcMore/it/unibo/qacoapanotherobserver/plans.txt";
	  	}
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "qacoapanotherobserver tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	//switchTo work
	        switchToPlanAsNextState(pr, myselfName, "qacoapanotherobserver_"+myselfName, 
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("work",-1);
	    	...
	    	temporaryStr = "\"qacoapanotherobserver STARTS \"";
	    	...
	    	createObserver();
	    	doCoapQuery( "globalkb" ,  "assign(a,200)" );
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"qacoapanotherobserver_"+myselfName,false,
