...
public abstract class AbstractQaledthingmqtt extends QActor implements IActivity{ 
	...
	protected IActorAction action;
		...
		protected static IOutputEnvView setTheEnv(IOutputEnvView outEnvView ){
			EnvFrame env = new EnvFrame( "Env_qaledthingmqtt", java.awt.Color.cyan  , java.awt.Color.black );
			env.init();
			env.setSize(800,430); 
			IOutputEnvView newOutEnvView = ((EnvFrame) env).getOutputEnvView();
			return newOutEnvView;
		}
		public AbstractQaledthingmqtt(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qaledthingmqtt/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			addInputPanel(80);
			addCmdPanels();
			this.planFilePath = "./srcMore/it/unibo/qaledthingmqtt/plans.txt";
	  	}
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "qaledthingmqtt tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	it.unibo.coap.platform.thingUtils.createLedThing( myself ,"8010"  );
	    	temporaryStr = "\"qaledthing STARTS\"";
	    	println( temporaryStr );  
	    	//delay  ( no more reactive within a plan)
	    	aar = delayReactive(600000,"" , "");
	    	if( aar.getInterrupted() ) curPlanInExec   = "init";
	    	if( ! aar.getGoon() ) return ;
	    	repeatPlanNoTransition(pr,myselfName,"qaledthingmqtt_"+myselfName,false,false);
