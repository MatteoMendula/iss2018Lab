%==============================================
% WorldTheory.pl for actor qacoapanotherobserver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacoapanotherobserver).	%%old version (deprecated)
actorobj(qatuqacoapanotherobserver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacoapanotherobserver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacoapanotherobserver" ). 
...
%-------------------------------------------------
%  User static rules about qacoapanotherobserver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
