%==============================================
% WorldTheory.pl for actor globalkb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuglobalkb).	%%old version (deprecated)
actorobj(qatuglobalkb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor globalkb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of globalkb" ). 
...
%-------------------------------------------------
%  User static rules about globalkb
%------------------------------------------------- 
/*
------------------------------------------------------------------------
