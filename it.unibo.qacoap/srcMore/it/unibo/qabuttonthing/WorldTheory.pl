%==============================================
% WorldTheory.pl for actor qabuttonthing
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqabuttonthing).	%%old version (deprecated)
actorobj(qatuqabuttonthing).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qabuttonthing
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qabuttonthing" ). 
...
%-------------------------------------------------
%  User static rules about qabuttonthing
%------------------------------------------------- 
/*
------------------------------------------------------------------------
