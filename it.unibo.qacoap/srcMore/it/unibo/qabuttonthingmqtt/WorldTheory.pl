%==============================================
% WorldTheory.pl for actor qabuttonthingmqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqabuttonthingmqtt).	%%old version (deprecated)
actorobj(qatuqabuttonthingmqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qabuttonthingmqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qabuttonthingmqtt" ). 
...
%-------------------------------------------------
%  User static rules about qabuttonthingmqtt
%------------------------------------------------- 
/*
------------------------------------------------------------------------
