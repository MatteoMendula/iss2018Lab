%==============================================
% WorldTheory.pl for actor qabuttonclient
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqabuttonclient).	%%old version (deprecated)
actorobj(qatuqabuttonclient).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qabuttonclient
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qabuttonclient" ). 
...
%-------------------------------------------------
%  User static rules about qabuttonclient
%------------------------------------------------- 
/*
------------------------------------------------------------------------
