%==============================================
% WorldTheory.pl for actor kbcaller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatukbcaller).	%%old version (deprecated)
actorobj(qatukbcaller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor kbcaller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of kbcaller" ). 
...
%-------------------------------------------------
%  User static rules about kbcaller
%------------------------------------------------- 
/*
------------------------------------------------------------------------
