%==============================================
% WorldTheory.pl for actor qacoapobserver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacoapobserver).	%%old version (deprecated)
actorobj(qatuqacoapobserver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacoapobserver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacoapobserver" ). 
...
%-------------------------------------------------
%  User static rules about qacoapobserver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
