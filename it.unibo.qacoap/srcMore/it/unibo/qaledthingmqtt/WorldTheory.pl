%==============================================
% WorldTheory.pl for actor qaledthingmqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledthingmqtt).	%%old version (deprecated)
actorobj(qatuqaledthingmqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledthingmqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledthingmqtt" ). 
...
%-------------------------------------------------
%  User static rules about qaledthingmqtt
%------------------------------------------------- 
/*
------------------------------------------------------------------------
