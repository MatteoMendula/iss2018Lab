%==============================================
% WorldTheory.pl for actor qablslogic
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqablslogic).	%%old version (deprecated)
actorobj(qatuqablslogic).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qablslogic
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qablslogic" ). 
...
%-------------------------------------------------
%  User static rules about qablslogic
%------------------------------------------------- 
/*
------------------------------------------------------------------------
