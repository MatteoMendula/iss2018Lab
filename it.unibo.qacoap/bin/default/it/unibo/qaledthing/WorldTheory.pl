%==============================================
% WorldTheory.pl for actor qaledthing
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledthing).	%%old version (deprecated)
actorobj(qatuqaledthing).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledthing
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledthing" ). 
...
%-------------------------------------------------
%  User static rules about qaledthing
%------------------------------------------------- 
/*
------------------------------------------------------------------------
