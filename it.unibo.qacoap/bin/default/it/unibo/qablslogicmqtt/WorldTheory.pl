%==============================================
% WorldTheory.pl for actor qablslogicmqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqablslogicmqtt).	%%old version (deprecated)
actorobj(qatuqablslogicmqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qablslogicmqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qablslogicmqtt" ). 
...
%-------------------------------------------------
%  User static rules about qablslogicmqtt
%------------------------------------------------- 
/*
------------------------------------------------------------------------
