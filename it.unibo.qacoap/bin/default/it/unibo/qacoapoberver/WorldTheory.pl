%==============================================
% WorldTheory.pl for actor qacoapoberver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacoapoberver).	%%old version (deprecated)
actorobj(qatuqacoapoberver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacoapoberver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacoapoberver" ). 
...
%-------------------------------------------------
%  User static rules about qacoapoberver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
