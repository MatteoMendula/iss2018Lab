%==============================================
% WorldTheory.pl for actor qacoapserveronly
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacoapserveronly).	%%old version (deprecated)
actorobj(qatuqacoapserveronly).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacoapserveronly
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacoapserveronly" ). 
...
%-------------------------------------------------
%  User static rules about qacoapserveronly
%------------------------------------------------- 
/*
------------------------------------------------------------------------
