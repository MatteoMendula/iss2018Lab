%==============================================
% WorldTheory.pl for actor qacoapserver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacoapserver).	%%old version (deprecated)
actorobj(qatuqacoapserver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacoapserver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacoapserver" ). 
...
%-------------------------------------------------
%  User static rules about qacoapserver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
