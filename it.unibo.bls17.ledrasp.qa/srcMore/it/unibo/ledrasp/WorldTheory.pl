%==============================================
% WorldTheory.pl for actor ledrasp
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledrasp).	%%old version (deprecated)
actorobj(qatuledrasp).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledrasp
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledrasp" ). 
...
%-------------------------------------------------
%  User static rules about ledrasp
%------------------------------------------------- 
/*
------------------------------------------------------------------------
