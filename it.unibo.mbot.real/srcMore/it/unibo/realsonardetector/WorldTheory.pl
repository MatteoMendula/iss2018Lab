%==============================================
% WorldTheory.pl for actor realsonardetector
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealsonardetector).	%%old version (deprecated)
actorobj(qaturealsonardetector).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realsonardetector
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realsonardetector" ). 
...
%-------------------------------------------------
%  User static rules about realsonardetector
%------------------------------------------------- 
/*
------------------------------------------------------------------------
