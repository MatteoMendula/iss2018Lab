%==============================================
% WorldTheory.pl for actor btuuonmockgui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubtuuonmockgui).	%%old version (deprecated)
actorobj(qatubtuuonmockgui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor btuuonmockgui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of btuuonmockgui" ). 
...
%-------------------------------------------------
%  User static rules about btuuonmockgui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
