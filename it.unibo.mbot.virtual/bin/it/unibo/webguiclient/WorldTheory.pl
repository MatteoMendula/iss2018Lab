%==============================================
% WorldTheory.pl for actor webguiclient
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuwebguiclient).	%%old version (deprecated)
actorobj(qatuwebguiclient).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor webguiclient
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of webguiclient" ). 
...
%-------------------------------------------------
%  User static rules about webguiclient
%------------------------------------------------- 
/*
------------------------------------------------------------------------
