%==============================================
% WorldTheory.pl for actor sonarguidetector
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarguidetector).	%%old version (deprecated)
actorobj(qatusonarguidetector).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarguidetector
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarguidetector" ). 
