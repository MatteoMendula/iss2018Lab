%==============================================
% WorldTheory.pl for actor robotpfrs
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotpfrs).	%%old version (deprecated)
actorobj(qaturobotpfrs).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotpfrs
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotpfrs" ). 
...
%-------------------------------------------------
%  User static rules about robotpfrs
%------------------------------------------------- 
/*
------------------------------------------------------------------------
