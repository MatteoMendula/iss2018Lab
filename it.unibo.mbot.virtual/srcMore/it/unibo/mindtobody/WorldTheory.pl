%==============================================
% WorldTheory.pl for actor mindtobody
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumindtobody).	%%old version (deprecated)
actorobj(qatumindtobody).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mindtobody
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mindtobody" ). 
...
%-------------------------------------------------
%  User static rules about mindtobody
%------------------------------------------------- 
/*
------------------------------------------------------------------------
