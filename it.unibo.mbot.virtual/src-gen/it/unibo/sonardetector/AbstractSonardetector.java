		...
		*/    
	    ...
	    try{	
	     ...
	     msgTransition( pr,myselfName,"sonardetector_"+myselfName,false,
	          new StateFun[]{stateTab.get("sendToRadar"), stateTab.get("showObstcle") },//new StateFun[]
	     ...
	     PlanRepeat pr = PlanRepeat.setUp("sendToRadar",-1);
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("sonar") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			...
	    			/* RaiseEvent */
	    			parg = updateVars(Term.createTerm("sonar(SONAR,TARGET,DISTANCE)"),  Term.createTerm("sonar(NAME,TARGET,DISTANCE)"), 
