%==============================================
% WorldTheory.pl for actor ledmqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledmqtt).	%%old version (deprecated)
actorobj(qatuledmqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledmqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledmqtt" ). 
...
%-------------------------------------------------
%  User static rules about ledmqtt
%------------------------------------------------- 
config( gui).
mqttServer( "tcp://m2m.eclipse.org:1883").
topicReceive( "unibo/mqtt/bls").
config( SERVER,nove,TRECEIVE):-mqttServer( SERVER),topicReceive( TRECEIVE).
/*
------------------------------------------------------------------------
