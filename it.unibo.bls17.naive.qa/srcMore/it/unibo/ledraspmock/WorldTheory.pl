%==============================================
% WorldTheory.pl for actor ledraspmock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledraspmock).	%%old version (deprecated)
actorobj(qatuledraspmock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledraspmock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledraspmock" ). 
...
%-------------------------------------------------
%  User static rules about ledraspmock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
