%==============================================
% WorldTheory.pl for actor qaactuator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaactuator).	%%old version (deprecated)
actorobj(qatuqaactuator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaactuator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaactuator" ). 
...
%-------------------------------------------------
%  User static rules about qaactuator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
