%==============================================
% WorldTheory.pl for actor ledimpl
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledimpl).	%%old version (deprecated)
actorobj(qatuledimpl).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledimpl
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledimpl" ). 
...
%-------------------------------------------------
%  User static rules about ledimpl
%------------------------------------------------- 
/*
------------------------------------------------------------------------
