%==============================================
% WorldTheory.pl for actor tofronted
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutofronted).	%%old version (deprecated)
actorobj(qatutofronted).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor tofronted
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of tofronted" ). 
...
%-------------------------------------------------
%  User static rules about tofronted
%------------------------------------------------- 
/*
------------------------------------------------------------------------
