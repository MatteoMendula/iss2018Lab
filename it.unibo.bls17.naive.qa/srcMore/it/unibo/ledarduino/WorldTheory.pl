%==============================================
% WorldTheory.pl for actor ledarduino
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledarduino).	%%old version (deprecated)
actorobj(qatuledarduino).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledarduino
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledarduino" ). 
...
%-------------------------------------------------
%  User static rules about ledarduino
%------------------------------------------------- 
/*
------------------------------------------------------------------------
