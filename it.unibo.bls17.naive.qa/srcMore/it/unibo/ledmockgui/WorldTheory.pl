%==============================================
% WorldTheory.pl for actor ledmockgui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledmockgui).	%%old version (deprecated)
actorobj(qatuledmockgui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledmockgui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledmockgui" ). 
...
%-------------------------------------------------
%  User static rules about ledmockgui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
