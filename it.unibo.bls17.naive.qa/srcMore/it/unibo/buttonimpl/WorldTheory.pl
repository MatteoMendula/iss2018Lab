%==============================================
% WorldTheory.pl for actor buttonimpl
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubuttonimpl).	%%old version (deprecated)
actorobj(qatubuttonimpl).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor buttonimpl
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of buttonimpl" ). 
...
%-------------------------------------------------
%  User static rules about buttonimpl
%------------------------------------------------- 
/*
------------------------------------------------------------------------
