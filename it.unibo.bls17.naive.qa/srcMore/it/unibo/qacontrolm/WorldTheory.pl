%==============================================
% WorldTheory.pl for actor qacontrolm
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrolm).	%%old version (deprecated)
actorobj(qatuqacontrolm).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrolm
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrolm" ). 
...
%-------------------------------------------------
%  User static rules about qacontrolm
%------------------------------------------------- 
/*
------------------------------------------------------------------------
