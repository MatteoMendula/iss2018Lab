%==============================================
% WorldTheory.pl for actor qasensor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqasensor).	%%old version (deprecated)
actorobj(qatuqasensor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qasensor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qasensor" ). 
...
%-------------------------------------------------
%  User static rules about qasensor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
