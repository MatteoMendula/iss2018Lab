%==============================================
% WorldTheory.pl for actor qaledm
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledm).	%%old version (deprecated)
actorobj(qatuqaledm).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledm
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledm" ). 
...
%-------------------------------------------------
%  User static rules about qaledm
%------------------------------------------------- 
ledmodel( name( led1),value( off)).
switchLedValue( on):-ledmodel( name( led1),value( off)),replaceRule( ledmodel( NAME,value( off)),ledmodel( NAME,value( on))), ! .
switchLedValue( off):-ledmodel( name( led1),value( on)),replaceRule( ledmodel( NAME,value( on)),ledmodel( NAME,value( off))), ! .
/*
------------------------------------------------------------------------
