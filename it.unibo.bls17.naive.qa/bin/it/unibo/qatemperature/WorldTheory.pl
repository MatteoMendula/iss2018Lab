%==============================================
% WorldTheory.pl for actor qatemperature
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqatemperature).	%%old version (deprecated)
actorobj(qatuqatemperature).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qatemperature
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qatemperature" ). 
...
%-------------------------------------------------
%  User static rules about qatemperature
%------------------------------------------------- 
/*
------------------------------------------------------------------------
