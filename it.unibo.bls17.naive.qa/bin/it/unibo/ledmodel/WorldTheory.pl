%==============================================
% WorldTheory.pl for actor ledmodel
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledmodel).	%%old version (deprecated)
actorobj(qatuledmodel).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledmodel
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledmodel" ). 
