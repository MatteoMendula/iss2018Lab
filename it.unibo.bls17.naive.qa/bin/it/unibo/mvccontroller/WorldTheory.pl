...
changedModelAction( temperature,t1,V):-limitTemperatureValue( MAX),eval( ge,V,MAX), ! ,changeModelItem( leds,led1,on).
changedModelAction( temperature,t1,V):-changeModelItem( leds,led1,off).
changedModelAction( leds,led1,V):-emitevent( ctrlEvent,ctrlEvent( leds,led1,V)).
/*
------------------------------------------------------------------------
