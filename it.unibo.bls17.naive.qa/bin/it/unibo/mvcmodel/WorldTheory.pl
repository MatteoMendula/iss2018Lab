%==============================================
% WorldTheory.pl for actor mvcmodel
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumvcmodel).	%%old version (deprecated)
actorobj(qatumvcmodel).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mvcmodel
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mvcmodel" ). 
...
%-------------------------------------------------
%  User static rules about mvcmodel
%------------------------------------------------- 
model( type( actuator,leds),name( led1),value( off)).
model( type( sensor,temperature),name( t1),value( 25)).
getmodelitem( TYPE,CATEG,NAME,VALUE):-model( type( TYPE,CATEG),name( NAME),value( VALUE)).
changemodelitem( TYPE,CATEG,NAME,VALUE):-replaceRule( model( type( TYPE,CATEG),name( NAME),value( _)),model( type( TYPE,CATEG),name( NAME),value( VALUE))), ! .
/*
------------------------------------------------------------------------
