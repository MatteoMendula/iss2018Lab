...
public abstract class AbstractQaledm extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQaledm(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qaledm/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/qaledm/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	it.unibo.custom.gui.customBlsGui.setLed( myself ,guardVars.get("V")  );
	    	}
	    	//switchTo waitForCmd
	        switchToPlanAsNextState(pr, myselfName, "qaledm_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qaledm_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("ledswitch",-1);
	    	...
	    	if( (guardVars = QActorUtils.evalTheGuard(this, " !?switchLedValue(V)" )) != null ){
	    	it.unibo.custom.gui.customBlsGui.setLed( myself ,guardVars.get("V")  );
	    	}
	    	repeatPlanNoTransition(pr,myselfName,"qaledm_"+myselfName,false,true);
