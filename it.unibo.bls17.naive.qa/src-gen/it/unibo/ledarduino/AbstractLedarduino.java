...
public abstract class AbstractLedarduino extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractLedarduino(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/ledarduino/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/ledarduino/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"ledarduino_"+myselfName,false,
	     ...
	     PlanRepeat pr = PlanRepeat.setUp("handleCmd",-1);
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("ctrlEvent") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			...
	    			String arg1 = "1" ;
	    			//end arg1
	    			it.unibo.utils.arduino.connArduino.sendToArduino(this,arg1 );
	    			}
	    	}
	    	//onEvent 
	    	setCurrentMsgFromStore(); 
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"ledarduino_"+myselfName,false,true);
