...
public abstract class AbstractQaactuator extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQaactuator(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qaactuator/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/qaactuator/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "qaactuator(starts)";
	    	println( temporaryStr );  
	    	it.unibo.custom.gui.customBlsGui.createCustomLedGui( myself  );
	    	//switchTo waitForCommand
	        switchToPlanAsNextState(pr, myselfName, "qaactuator_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qaactuator_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleCmd",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"qaactuator_"+myselfName,false,true);
