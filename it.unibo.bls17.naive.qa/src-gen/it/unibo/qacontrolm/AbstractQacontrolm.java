...
public abstract class AbstractQacontrolm extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQacontrolm(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qacontrolm/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/qacontrolm/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "qacontrolm_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qacontrolm_"+myselfName,false,
	          ...
	          try{
	            ...
	            //ActionSwitch for a message or event
	             if( currentEvent.getMsg().startsWith("clicked") ){
	            	...
	            	if( parg != null ) sendMsg("turn","qaledm", QActorContext.dispatch, parg ); 
	             }
