%==============================================
% WorldTheory.pl for actor mbotled
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumbotled).	%%old version (deprecated)
actorobj(qatumbotled).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mbotled
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mbotled" ). 
