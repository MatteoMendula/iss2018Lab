...
public abstract class AbstractLedhandler extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractLedhandler(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/ledhandler/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/ledhandler/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"ledhandler STARTS\"";
	    	...
	    	println( temporaryStr );  
	    	//switchTo waitForCmd
	        switchToPlanAsNextState(pr, myselfName, "ledhandler_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"ledhandler_"+myselfName,false,
	          new StateFun[]{stateTab.get("execMove") }, 
	          new String[]{" !?handleLed" ,"M","moveMbot" },
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("execMove",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"ledhandler_"+myselfName,false,true);
