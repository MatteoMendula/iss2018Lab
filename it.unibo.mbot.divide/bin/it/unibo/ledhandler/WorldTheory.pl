%==============================================
% WorldTheory.pl for actor ledhandler
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledhandler).	%%old version (deprecated)
actorobj(qatuledhandler).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledhandler
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledhandler" ). 
...
%-------------------------------------------------
%  User static rules about ledhandler
%------------------------------------------------- 
handleLed.
/*
------------------------------------------------------------------------
