...
public class MyExampleCrossProxy {
	...
	public MyExampleCrossProxy() throws IOException {
		...
		MyProxyHttpServer httpServer = new MyProxyHttpServer(8080);
...
// 		httpServer.setProxyCoapResolver( new DirectProxyCoapResolver(coap2http) ); 		
//		System.out.println("CoAP resource \"target\" available over HTTP at: http://localhost:8080/proxy/http://localhost:PORT/target");
	}
	...
	private static class TargetResource extends CoapResource {
		...
		public void handleGET(CoapExchange exchange) {
			...
			//exchange.respond(  "<html>NOT UDERSTAND</html>" );
			//exchange.respond( ResponseCode.CONTENT, "<html>NOT UDERSTAND .... </html>".getBytes() );
 		}
