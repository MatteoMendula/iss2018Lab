%==============================================
% WorldTheory.pl for actor testeruser1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutesteruser1).	%%old version (deprecated)
actorobj(qatutesteruser1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testeruser1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testeruser1" ). 
...
%-------------------------------------------------
%  User static rules about testeruser1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
