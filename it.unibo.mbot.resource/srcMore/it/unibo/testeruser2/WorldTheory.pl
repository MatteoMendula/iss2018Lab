%==============================================
% WorldTheory.pl for actor testeruser2
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutesteruser2).	%%old version (deprecated)
actorobj(qatutesteruser2).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testeruser2
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testeruser2" ). 
...
%-------------------------------------------------
%  User static rules about testeruser2
%------------------------------------------------- 
/*
------------------------------------------------------------------------
