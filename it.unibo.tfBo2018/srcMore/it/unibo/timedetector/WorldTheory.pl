%==============================================
% WorldTheory.pl for actor timedetector
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutimedetector).	%%old version (deprecated)
actorobj(qatutimedetector).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor timedetector
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of timedetector" ). 
...
%-------------------------------------------------
%  User static rules about timedetector
%------------------------------------------------- 
/*
------------------------------------------------------------------------
