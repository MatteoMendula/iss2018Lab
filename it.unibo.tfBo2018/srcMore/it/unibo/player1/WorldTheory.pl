%==============================================
% WorldTheory.pl for actor player1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuplayer1).	%%old version (deprecated)
actorobj(qatuplayer1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor player1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of player1" ). 
...
%-------------------------------------------------
%  User static rules about player1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
