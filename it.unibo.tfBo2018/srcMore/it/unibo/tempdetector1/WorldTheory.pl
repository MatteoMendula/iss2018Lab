%==============================================
% WorldTheory.pl for actor tempdetector1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutempdetector1).	%%old version (deprecated)
actorobj(qatutempdetector1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor tempdetector1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of tempdetector1" ). 
...
%-------------------------------------------------
%  User static rules about tempdetector1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
