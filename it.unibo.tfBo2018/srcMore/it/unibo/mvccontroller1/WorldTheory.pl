%==============================================
% WorldTheory.pl for actor mvccontroller1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumvccontroller1).	%%old version (deprecated)
actorobj(qatumvccontroller1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mvccontroller1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mvccontroller1" ). 
...
%-------------------------------------------------
%  User static rules about mvccontroller1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
