%==============================================
% WorldTheory.pl for actor mvccontroller0
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumvccontroller0).	%%old version (deprecated)
actorobj(qatumvccontroller0).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mvccontroller0
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mvccontroller0" ). 
...
%-------------------------------------------------
%  User static rules about mvccontroller0
%------------------------------------------------- 
/*
------------------------------------------------------------------------
