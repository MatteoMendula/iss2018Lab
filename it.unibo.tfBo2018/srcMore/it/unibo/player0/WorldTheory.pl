%==============================================
% WorldTheory.pl for actor player0
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuplayer0).	%%old version (deprecated)
actorobj(qatuplayer0).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor player0
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of player0" ). 
...
%-------------------------------------------------
%  User static rules about player0
%------------------------------------------------- 
/*
------------------------------------------------------------------------
