%==============================================
% WorldTheory.pl for actor tempdetector
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutempdetector).	%%old version (deprecated)
actorobj(qatutempdetector).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor tempdetector
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of tempdetector" ). 
...
%-------------------------------------------------
%  User static rules about tempdetector
%------------------------------------------------- 
/*
------------------------------------------------------------------------
