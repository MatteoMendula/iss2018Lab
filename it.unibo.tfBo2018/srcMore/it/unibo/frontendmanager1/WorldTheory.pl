%==============================================
% WorldTheory.pl for actor frontendmanager1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatufrontendmanager1).	%%old version (deprecated)
actorobj(qatufrontendmanager1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor frontendmanager1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of frontendmanager1" ). 
...
%-------------------------------------------------
%  User static rules about frontendmanager1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
