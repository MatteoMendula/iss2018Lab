%==============================================
% WorldTheory.pl for actor robotdemo
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotdemo).	%%old version (deprecated)
actorobj(qaturobotdemo).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotdemo
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotdemo" ). 
...
%-------------------------------------------------
%  User static rules about robotdemo
%------------------------------------------------- 
/*
------------------------------------------------------------------------
