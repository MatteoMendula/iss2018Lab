%==============================================
% WorldTheory.pl for actor robotplayer
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotplayer).	%%old version (deprecated)
actorobj(qaturobotplayer).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotplayer
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotplayer" ). 
...
%-------------------------------------------------
%  User static rules about robotplayer
%------------------------------------------------- 
/*
------------------------------------------------------------------------
