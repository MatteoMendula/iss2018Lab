...
public abstract class AbstractPressphysicalsimulator extends QActor implements IActivity{ 
	...
	protected IActorAction action;
		...
		protected static IOutputEnvView setTheEnv(IOutputEnvView outEnvView ){
			EnvFrame env = new EnvFrame( "Env_pressphysicalsimulator", java.awt.Color.green  , java.awt.Color.black );
			env.init();
			env.setSize(800,430); 
			IOutputEnvView newOutEnvView = ((EnvFrame) env).getOutputEnvView();
			return newOutEnvView;
		}
		public AbstractPressphysicalsimulator(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/pressphysicalsimulator/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			addInputPanel(80);
			addCmdPanels();
			this.planFilePath = "./srcMore/it/unibo/pressphysicalsimulator/plans.txt";
	  	}
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "pressphysicalsimulator tout : stops");  
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	temporaryStr = "\"pressphysical starts\"";
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"pressphysicalsimulator_"+myselfName,false,
	          new StateFun[]{() -> {	//AD HOC state to execute an action and resumeLastPlan
	          try{
	            PlanRepeat pr1 = PlanRepeat.setUp("adhocstate",-1);
	            //ActionSwitch for a message or event
	             if( currentMessage.msgContent().startsWith("euromap63") ){
	            	String parg = "pressphysicalsimulator(CMD)";
	            	/* Print */
	            	parg =  updateVars( Term.createTerm("euromap63(CMD)"), 
	            	                    Term.createTerm("euromap63(CMD)"), 
