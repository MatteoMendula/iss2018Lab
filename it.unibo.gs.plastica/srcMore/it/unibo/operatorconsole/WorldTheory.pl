%==============================================
% WorldTheory.pl for actor operatorconsole
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuoperatorconsole).	%%old version (deprecated)
actorobj(qatuoperatorconsole).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor operatorconsole
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of operatorconsole" ). 
...
%-------------------------------------------------
%  User static rules about operatorconsole
%------------------------------------------------- 
/*
------------------------------------------------------------------------
