%==============================================
% WorldTheory.pl for actor elabactor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuelabactor).	%%old version (deprecated)
actorobj(qatuelabactor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor elabactor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of elabactor" ). 
...
%-------------------------------------------------
%  User static rules about elabactor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
