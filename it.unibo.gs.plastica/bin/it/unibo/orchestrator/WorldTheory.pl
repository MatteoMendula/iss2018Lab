%==============================================
% WorldTheory.pl for actor orchestrator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuorchestrator).	%%old version (deprecated)
actorobj(qatuorchestrator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor orchestrator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of orchestrator" ). 
...
%-------------------------------------------------
%  User static rules about orchestrator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
