%==============================================
% WorldTheory.pl for actor pressphysicalsimulator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatupressphysicalsimulator).	%%old version (deprecated)
actorobj(qatupressphysicalsimulator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor pressphysicalsimulator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of pressphysicalsimulator" ). 
...
%-------------------------------------------------
%  User static rules about pressphysicalsimulator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
