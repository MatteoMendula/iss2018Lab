%==============================================
% WorldTheory.pl for actor presslogical
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatupresslogical).	%%old version (deprecated)
actorobj(qatupresslogical).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor presslogical
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of presslogical" ). 
...
%-------------------------------------------------
%  User static rules about presslogical
%------------------------------------------------- 
/*
------------------------------------------------------------------------
