%==============================================
% WorldTheory.pl for actor qarescuer
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqarescuer).	%%old version (deprecated)
actorobj(qatuqarescuer).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qarescuer
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qarescuer" ). 
...
%-------------------------------------------------
%  User static rules about qarescuer
%------------------------------------------------- 
