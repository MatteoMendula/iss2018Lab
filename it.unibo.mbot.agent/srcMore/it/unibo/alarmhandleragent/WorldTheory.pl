%==============================================
% WorldTheory.pl for actor alarmhandleragent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatualarmhandleragent).	%%old version (deprecated)
actorobj(qatualarmhandleragent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor alarmhandleragent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of alarmhandleragent" ). 
...
%-------------------------------------------------
%  User static rules about alarmhandleragent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
