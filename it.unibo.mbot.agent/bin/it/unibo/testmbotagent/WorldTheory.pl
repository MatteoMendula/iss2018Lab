%==============================================
% WorldTheory.pl for actor testmbotagent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestmbotagent).	%%old version (deprecated)
actorobj(qatutestmbotagent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testmbotagent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testmbotagent" ). 
...
%-------------------------------------------------
%  User static rules about testmbotagent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
