%==============================================
% WorldTheory.pl for actor testsystem
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestsystem).	%%old version (deprecated)
actorobj(qatutestsystem).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testsystem
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testsystem" ). 
...
%-------------------------------------------------
%  User static rules about testsystem
%------------------------------------------------- 
/*
------------------------------------------------------------------------
