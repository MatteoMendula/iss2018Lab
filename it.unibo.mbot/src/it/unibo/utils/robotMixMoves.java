...
public class robotMixMoves {
	...
	public static void moveRobotAndAvatar(QActor qa, String move, String speedStr, String timeStr) {
		try { 
//			System.out.println(" ***   moveRobotAndAvatar dir= "  + qa.getPrologEngine().getCurrentDirectory() );
			System.out.println(" ***   moveRobotAndAvatar "  + move );
			...
			switch( move ) {
				...
				case "backward" :{
					qa.println("	*** ROBOT REAL BACKWARD ");
					it.unibo.rover.mbotConnArduino.mbotBackward(qa);
					qa.println("	*** ROBOT AVATAR BACKWARD ");
